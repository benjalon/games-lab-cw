...
void game::prototypes::register_prototypes()
{
	...
	PROTOTYPE(AIModel, ModelComponent, ColourComponent, TransformComponent, KinematicComponent, AIComponent, CameraComponent, BulletComponent);
	PROTOTYPE(DetectionRadius, ModelComponent, ColourComponent, TransformComponent, CollisionComponent);
