...
void game::GameEngine::run()
{
	...
	scene_.instantiate("Key", m_key1, t_key1, k_key1);
	scene_.instantiate("PointLight", PointLightComponent{ {1, 210 / 255.0, 180.0 / 255.0}, 40, t_key1.position });
	...
	scene_.instantiate("Key", m_key2, t_key2, k_key2);
	scene_.instantiate("PointLight", PointLightComponent{ {1, 210 / 255.0, 180.0 / 255.0}, 40, t_key2.position });
	...
	scene_.instantiate("Key", m_key3, t_key3, k_key3);
	scene_.instantiate("PointLight", PointLightComponent{ {1, 210 / 255.0, 180.0 / 255.0}, 40, t_key3.position });
	...
	scene_.instantiate("Key", m_key4, t_key4, k_key4);
	scene_.instantiate("PointLight", PointLightComponent{ {1, 210 / 255.0, 180.0 / 255.0}, 40, t_key4.position });
	...
	scene_.instantiate("Key", m_key5, t_key5, k_key5);
	scene_.instantiate("PointLight", PointLightComponent{ {1, 210 / 255.0, 180.0 / 255.0}, 40, t_key5.position });
	...
	scene_.instantiate("Key", m_key6, t_key6, k_key6);
	scene_.instantiate("PointLight", PointLightComponent{ {1, 210 / 255.0, 180.0 / 255.0}, 40, t_key6.position });
